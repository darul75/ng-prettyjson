...
angular.isObject(a)&&b(a.json)?(i(),c.$watch(j+".json",function(a){k(a),f=a},!0)):(k(a),f=a),h&&h.setValue(a)},!0);var l=function(){try{f=JSON.parse(h.getValue()),c.parsable=!0}catch(a){c.parsable=!1}// trigger update
